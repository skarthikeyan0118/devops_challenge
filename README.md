...
Now, my AWS VM instance is ready running with docker and jenkins installed in it.

Create Docker file: 

The Docker file contains my app index.html and copy it to my nginx container. 
